...
function logout(){
	if (!confirm("로그아웃 하시겠습니까?")) {
    	...
    	window.location.href = "/web/statistics/general/logout.do";
    }
}
</script>
<div class="menu">
	<div id="diagnosis_data_btn" class="menu_btn" onclick="location.href='/web/statistics/general/diagnosis'">진단 결과지</div>
	<div id="diagnosis_graph_btn" class="menu_btn"  onclick="location.href='/web/statistics/general/graph'">구강관리에 따른 원아 순위</div>
