									...
									<table class="table table-bordered">
										...
										<tr>
											...
											<td class="td-right searchDt">
												<input type="text" id="boardEventStartDt" name="boardEventStartDt" placeholder="시작일" />
													~
												<input type="text" id="boardEventEndDt" name="boardEventEndDt" placeholder="종료일" />
											</td>
										</tr>	
										<tr>
											<th class="th-title">제목</th>
											<td colspan="3" class="td-title">
												<input type="text" id="boardTitle" name="boardTitle" class="input-text" placeholder="제목"/>
											</td>
										</tr>
										<tr>
											<th class="th-url">팝업 이미지 URL 주소</th>
											<td colspan="3" class="td-url">
												<input type="text" id="boardImgPreviewUrl" name="boardImgPreviewUrl" class="input-text" placeholder="팝업 이미지 URL 주소"/>
											</td>
										</tr>				
										<tr>
											<th class="th-url">본문 이미지 URL 주소</th>
											<td colspan="3" class="td-url">
												<input type="text" id="boardImgUrl" name="boardImgUrl" class="input-text" placeholder="본문 이미지 URL 주소"/>
											</td>
										</tr>				
										<tr>
