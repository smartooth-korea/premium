...
<body id="page-top">
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body organList">
									<div class="row no-gutters align-items-center">
										...
										<div class="col-auto">
											<i class="fas fa-fw fa-bug" aria-hidden="true"></i>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4 gridHeight">
								...
								<div class="card-body">
									...
									<div class="regist">
										<button type="button" class="btn btn-info btn-fill button" style="margin: 0px; margin-top: 20px; width: 15%;" onclick="location.href='/admin/board/insertBugReport';">버그리포트 작성</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var colNameArray =
				[ 
					'등록번호', '분류', '제목', '작성자', '작성일', '진행상태'
				];

			$("#grid").jqGrid(
				{
					url : "/admin/board/selectBugReportList.do",
					datatype : "json",
					styleUI : 'Foundation',
					...
					colModel : [ {
						...
						name : 'boardStatusHtml',
						index : 'boardStatusHtml',
						width : '10%',
						align : 'center'
					} ],
					...
					onSelectRow : function(rowId, iRow, iCol, e) {
						...
						window.location.href='/admin/board/selectBugReportView.do?boardSeq='+boardSeq;
					}
				});
		});
